 ...
 *
 * @author alumno
 * calse para consultar las ventas
 */
public class VerVentas extends javax.swing.JFrame {
    ...
    private void jButtonBuscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonBuscarActionPerformed
        ...
        if(jComboBoxCliente.getSelectedIndex()==0){
            jTable1.setModel(bd.rellenarTablaVentasT());
        }else{
            Cliente c = (Cliente)jComboBoxCliente.getSelectedItem();
            jTable1.setModel(bd.rellenarTablaVentas(c.getCodigo()));
        }
